...
CREATE TABLE `kund` (
  `id` int NOT NULL AUTO_INCREMENT,
  `förnamn` varchar(45) DEFAULT NULL,
  `efternamn` varchar(45) DEFAULT NULL,
  `ort` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `indexnamn` (`förnamn`)
  -- Jag har valt att implementera index så att man lätt kan söka på en kunds namn
);
/*
...
CREATE TABLE `produkt` (
  `id` int NOT NULL AUTO_INCREMENT,
  `märke` varchar(45) DEFAULT NULL,
  `storlek` int DEFAULT NULL,
  `färg` varchar(45) DEFAULT NULL,
  `pris` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`id`)
);
/*
...
CREATE TABLE `produktbetyg` (
  ...
  KEY `foreignkeyproduktbetyg_produkt_idx` (`produktid`),
  KEY `foreignkeyproduktbetyg_betyg_idx` (`betygid`),
  CONSTRAINT `foreignkeyproduktbetyg_betyg` FOREIGN KEY (`betygid`) REFERENCES `betyg` (`id`),
  CONSTRAINT `foreignkeyproduktbetyg_kund` FOREIGN KEY (`kundid`) REFERENCES `kund` (`id`),
  CONSTRAINT `foreignkeyproduktbetyg_produkt` FOREIGN KEY (`produktid`) REFERENCES `produkt` (`id`)
);
/*
...
CREATE TABLE `produktkategori` (
  ...
  KEY `foreignkeykategori_idx` (`kategoriid`),
  CONSTRAINT `foreignkeyproduktkategori_kategori` FOREIGN KEY (`kategoriid`) REFERENCES `kategori` (`id`),
  CONSTRAINT `foreignkeyproduktkategori_produkt` FOREIGN KEY (`produktid`) REFERENCES `produkt` (`id`)
);
/*
...
CREATE TABLE `beställning` (
  ...
  `kundid` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `foreignkeykund_idx` (`kundid`),
  CONSTRAINT `foreignkeykund` FOREIGN KEY (`kundid`) REFERENCES `kund` (`id`)
);
/*
...
CREATE TABLE `beställningsrad` (
  ...
  KEY `foreignkeybeställning_idx` (`beställningsid`),
  KEY `foreignkeyprodukt_idx` (`produktid`),
  CONSTRAINT `foreignkeybeställning` FOREIGN KEY (`beställningsid`) REFERENCES `beställning` (`id`),
  CONSTRAINT `foreignkeyprodukt` FOREIGN KEY (`produktid`) REFERENCES `produkt` (`id`)
);
